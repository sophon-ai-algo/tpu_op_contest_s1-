...
int main() {
    ...
    param_t params[] = {
        ...
        {.N=1,      .C=256,     .H=12,      .W=64,      .order={0,2,1,3}},  //5
        {.N=37,     .C=25,      .H=2,       .W=128,     .order={0,2,1,3}},  //6
        {.N=576,    .C=2,       .H=2,       .W=1024,    .order={0,3,1,2}},  //7
        {.N=1,      .C=24,      .H=24,      .W=128,     .order={0,3,1,2}},  //8
        {.N=1,      .C=1,       .H=60000,   .W=4,       .order={0,3,2,1}},  //9
        {.N=1,      .C=12,      .H=256,     .W=64,      .order={0,1,3,2}},  //10
        {.N=1,      .C=384,     .H=10,      .W=30,      .order={3,0,1,2}},  //11
        {.N=1,      .C=256,     .H=1,       .W=79,      .order={2,3,0,1}},  //12
        {.N=1,      .C=1,       .H=60000,   .W=4,       .order={0,3,2,1}},  //13
        {.N=64,     .C=1,       .H=128,     .W=256,     .order={1,0,2,3}},  //14
    };
